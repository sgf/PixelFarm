...
namespace PixelFarm.Contours
{
    public class IntermediateOutline
    {
        ...
        private List<AnalyzedTriangle> _allTriangles;

        private float _bounds_minX, _bounds_minY, _bounds_maxX, _bounds_maxY;
        ...
        private void CreateCentroidLineHubs(List<Polygon> polygons)
        {
        ...
        private static void CreateCentroidLineHubs(Polygon polygon, List<AnalyzedTriangle> triangles, List<CentroidLineHub> outputLineHubs)
        {
            int id = 0;
        ...
        private static int FindLatestConnectedTri(List<AnalyzedTriangle> usedTriList, AnalyzedTriangle tri)
        {
            //search back ***
