...
public class Spline2D
{
    ...
    private List<DistanceToT> _distanceToTList = new List<DistanceToT>();
    ...
    private static bool Approximately(float a, float b) => Math.Abs(a - b) < float.Epsilon;
    ...
    private static PointF Lerp(PointF from, PointF to, float frac)
    {
    ...
    private Vector2 MakeTangent(Vector2 p1, Vector2 p2) => _curvature * (p2 - p1);
