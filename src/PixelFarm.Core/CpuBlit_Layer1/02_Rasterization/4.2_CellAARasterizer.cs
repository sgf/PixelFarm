...
public partial class ScanlineRasterizer
{
    //-----------------------------------------------------------------cell_aa
    ...
    private readonly struct CellAA
    {
    ...
    private struct CellAABlob
    {
        private readonly CellAARasterizer _cellAARas;
...
#if DEBUG
        private bool _dbugLockSortCell;
    ...
    private sealed class CellAARasterizer
    {
        private int _num_used_cells;
        private ArrayList<CellAA> _cells;
        private readonly ArrayList<CellAA> _sorted_cells;
        private readonly ArrayList<SortedY> _sorted_y;

        //------------------
        private int _cCell_x;

        private int _cCell_y;
        private int _cCell_cover;
        private int _cCell_area;
        //------------------
#if DEBUG
        private int _cCell_left;
        private int _cCell_right;
#endif
        ...
        private const int BLOCK_POOL = 256;
        private const int BLOCK_LIMIT = BLOCK_SIZE * 1024;
        ...
        private const int DX_LIMIT = (16384 << PolySubPix.SHIFT);
        private const int POLY_SUBPIXEL_SHIFT = PolySubPix.SHIFT;
        private const int POLY_SUBPIXEL_MASK = PolySubPix.MASK;
        private const int POLY_SUBPIXEL_SCALE = PolySubPix.SCALE;
        ...
        private static class QuickSort
        {
            ...
            private static int GetPivotPoint(CellAA[] dataToSort, int begPoint, int endPoint)
            {
                int pivot = begPoint;
                int m = begPoint + 1;
                int n = endPoint;
