...
public partial class ScanlineRasterizer
{
    ...
    /// rect-clipper
    /// </summary>
    private class VectorClipper
    {
        private Q1Rect _clipBox;
        private int _x1;
        private int _y1;
        private int _f1;
        private bool _clipping;
        private readonly CellAARasterizer _ras;
        ...
        /// </summary>
        private bool _clipBoxWidthX3ForSubPixelLcdEffect = false; //default
        ...
        //------------------------------------------------------------------------
        private void LineClipY(int x1, int y1,
                       int x2, int y2,
                       int f1, int f2)
        {
            f1 &= 10;
