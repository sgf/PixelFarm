...
{
    private int _vertices_count;
    private int _allocated_vertices_count;
    private double[] _coord_xy;
    private byte[] _cmds;

#if DEBUG
    public readonly bool dbugIsTrim;
    private static int dbugTotal = 0;
    public readonly int dbugId = dbugGetNewId();
    public int dbugNote;

    private static int dbugGetNewId()
    {
        return dbugTotal++;
    }
    ...
    private void AllocIfRequired(int indexToAdd)
    {
...
public static class VertexHelper
{
    ...
    //--------------------------------------------------------------------
    private static int ArrangePolygonOrientation(VertexStore myvxs, int start, bool clockwise)
    {
    ...
    private static int ArrangeOrientations(VertexStore myvxs, int start, bool closewise)
    {
        while (start < myvxs.Count)
        {
    ...
    private static bool IsCW(VertexStore myvxs, int start, int end)
    {
    ...
    private static void InvertPolygon(VertexStore myvxs, int start, int end)
    {
        int i;
