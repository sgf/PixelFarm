...
namespace PixelFarm.CpuBlit.Rasterization.Lines
{
    public abstract class LineRenderer
    {
        ...
        public abstract void Line0(in LineParameters lp);

        public abstract void Line1(in LineParameters lp, int sx, int sy);

        public abstract void Line2(in LineParameters lp, int ex, int ey);

        public abstract void Line3(in LineParameters lp, int sx, int sy, int ex, int ey);
    }

    //-----------------------------------------------------------line_coord_sat
    internal static class LineCoordSat
    {
