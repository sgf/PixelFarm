...
namespace PixelFarm.CpuBlit.FragmentProcessing
{
    ...
    {
        private const int GAMMA_SHIFT = 8;
        private const int GAMMA_SIZE = 1 << GAMMA_SHIFT;
        private const int GAMMA_MASK = GAMMA_SIZE - 1;
        private float _gamma;
        private byte[] _dir_gamma;
        private byte[] _inv_gamma;
